    ...
    <div class="w-24 lg:w-48 sideNav">
        <div class="flex flex-col space-y-3">
            ...
            <ul class="flex flex-col space-y-2 cursor-pointer break-all">
                <li :class="['py-1 lg:py-2 px-1 lg:px-4 lg:pl-6 bg-white hover:bg-gray-100 rounded-r-full btn text-gray-700 hover:text-blue-700 flex space-x-2 items-center pl-5',
