...
<template>
  <div class="py-2 px-4 border-dashed border-2 rounded border-transparent flex flex-col">
    <span class="text-xl text-fuchsia-600 font-semibold pl-5" :key="1">Item(s) To Buy</span>
    <TransitionGroup
      name="list"
      tag="div"
      class="relative py-1 px-3 flex flex-col w-96 h-72 lg:h-96 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-track-green-50 scrollbar-thumb-green-500"
    >
