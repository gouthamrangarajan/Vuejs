...
<template>
  <div class="py-2 px-4 border-dashed border-2 rounded border-transparent flex flex-col">
    ...
    <TransitionGroup
      name="list"
      tag="div"
      class="relative py-1 px-3 flex flex-col w-96 h-80 lg:h-96 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-track-green-50 scrollbar-thumb-green-500"
    >
